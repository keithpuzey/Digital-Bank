   ...
   stages {
      stage('Development') {
         steps {
            ...
            script {
               def response = httpRequest authentication: 'credentialsID', contentType: 'APPLICATION_JSON', httpMode: 'POST', url: "https://mock.blazemeter.com/api/v1/workspaces/350345/service-mocks"
