...
"repeat":"5",
"datasources": [ { "id": {"fileName": "Pre_Prod_Environment/EnvironmentDetails.csv" }, "type": "csv","name": "Pre_Prod_Environment/EnvironmentDetails.csv","loop": true}]
}}}"""
