...
pipeline {
   ...
   stages {
	...
	// KeithP Workspace and VISA Payment Service
	   def patchOrg = """{ "description": "test", "endpointPreference": "HTTPS", "harborId": "1234", "id": 0, "type": "TRANSACTIONAL", "liveSystemHost": "string", "liveSystemPort": 0, "name": "my system", "noMatchingRequestPreference": "string", "noMatchingRequestTxnId": 0, "serviceId": 1180, "thinkTime": 0, "mockServiceTransactions": [ {"txnId":14928, "priority":9} ]}"""
